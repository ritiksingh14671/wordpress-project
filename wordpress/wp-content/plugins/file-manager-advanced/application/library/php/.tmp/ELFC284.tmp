                                                ...
                                                <div class="owl-carousel owl-theme">
                                                    <div class="themesflat-partner style-1 align-center clearfix">
                                                        <div class="partner-item">
                                                            <div class="inner">
                                                                <div class="thumb">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-1.png" alt="Image" class="partner-default">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-1-color.png" alt="Image" class="partner-color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="themesflat-partner style-1 align-center clearfix">
                                                        <div class="partner-item">
                                                            <div class="inner">
                                                                <div class="thumb">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-2.png" alt="Image" class="partner-default">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-2-color.png" alt="Image" class="partner-color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- /themesflat-partner -->
                                                    <div class="themesflat-partner style-1  align-center clearfix">
                                                        <div class="partner-item">
                                                            <div class="inner">
                                                                <div class="thumb">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-3.png" alt="Image" class="partner-default">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-3-color.png" alt="Image" class="partner-color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- /themesflat-partner -->
                                                    <div class="themesflat-partner style-1 align-center clearfix">
                                                        <div class="partner-item">
                                                            <div class="inner">
                                                                <div class="thumb">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-4.png" alt="Image" class="partner-default">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-4-color.png" alt="Image" class="partner-color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- /themesflat-partner -->
                                                    <div class="themesflat-partner style-1 align-center clearfix">
                                                        <div class="partner-item">
                                                            <div class="inner">
                                                                <div class="thumb">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-5.png" alt="Image" class="partner-default">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/partners/partner-5-color.png" alt="Image" class="partner-color">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- /themesflat-partner -->
                                                ...
                                                <div class="owl-carousel owl-theme">
                                                        ...
                                                        <div class="team-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/team/member-1-370x359.jpg" alt="Image">
                                                    ...
                                                    <div class="themesflat-team style-1 align-center clearfix">
                                                        <div class="team-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/team/member-2-370x359.jpg" alt="Image">
                                                                    <ul class="socials clearfix">
                                                                        <li class="facebook"><a href="#"><i class="autora-icon-facebook"></i></a></li>
                                                                        <li class="twitter"><a href="#"><i class="autora-icon-twitter"></i></a></li>
                                                                        <li class="camera"><a href="#"><i class="autora-icon-camera-outline"></i></a></li>
                                                    ...
                                                    <div class="themesflat-team style-1 align-center clearfix">
                                                        <div class="team-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/team/member-3-370x359.jpg" alt="Image">
                                                                    <ul class="socials clearfix">
                                                                        <li class="facebook"><a href="#"><i class="autora-icon-facebook"></i></a></li>
                                                                        <li class="twitter"><a href="#"><i class="autora-icon-twitter"></i></a></li>
                                                                        <li class="camera"><a href="#"><i class="autora-icon-camera-outline"></i></a></li>
