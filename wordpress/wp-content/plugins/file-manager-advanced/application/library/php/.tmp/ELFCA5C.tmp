...
/assets/img/chapa/banner3.jpg" alt="" data-bgposition="center center" data-no-retina>
                                        ...
                                        <li data-transition="random">
                                            <!-- Main Image -->
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>
/assets/img/chapa/banner2.jpg" alt="" data-bgposition="center center" data-no-retina>
                                        ...
                                        <li data-transition="random">
                                            <!-- Main Image -->
                                            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>
/assets/img/chapa/banner1.jpg" alt="" data-bgposition="center center" data-no-retina>
                            ...
                            <!-- END WELCOME TO Chappakhana -->

                            <!-- WELCOME TO BlackPaper -->
                            <div class="row-about">
                                <div class="container-fluid">
                                    <div class="row equalize sm-equalize-auto">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <ul class="themesflat-filter style-1 clearfix">
                                                                    ...
                                                                    <li><a href="#" data-filter=".green">GOYENDA</a></li>
                                                                    <li><a href="#" data-filter=".architecture">GOLPO   </a></li>
                                                                    <li><a href="#" data-filter=".construction">PROBONDO</a></li>
                                                                    <li><a href="#" data-filter=".villa">HORROR</a></li>
                                                                    <li><a href="#" data-filter=".building">SPORTS</a></li>
                                                                </ul> 
                                                                ...
                                                                <div class="themesflat-project style-2 isotope-project has-margin mg15 data-effect clearfix">
                                                                    <div class="project-item green villa">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-1-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                    ...
                                                                    <div class="project-item architecture building construction">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-2-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                                    <a href="#" class="icon-1 icon-search"></a>
                                                                                    <a href="#" class="icon-1"></a>
                                                                                </div>
                                                                    ...
                                                                    <div class="project-item villa architecture building construction">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-3-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                                    <a href="#" class="icon-1 icon-search"></a>
                                                                                    <a href="#" class="icon-1"></a>
                                                                                </div>
                                                                    ...
                                                                    <div class="project-item green villa">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-4-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                                    <a href="#" class="icon-1 icon-search"></a>
                                                                                    <a href="#" class="icon-1"></a>
                                                                                </div>
                                                                    ...
                                                                    <div class="project-item architecture building construction">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-5-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                                    <a href="#" class="icon-1 icon-search"></a>
                                                                                    <a href="#" class="icon-1"></a>
                                                                                </div>
                                                                    ...
                                                                    <div class="project-item villa green">
                                                                        <div class="inner">
                                                                            <div class="thumb data-effect-item has-effect-icon w40 offset-v-19 offset-h-49">
                                                                                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/project/project-6-370x245.jpg" alt="Image">                                                                    
                                                                                <div class="elm-link">
                                                                                    <a href="#" class="icon-1 icon-search"></a>
                                                                                    <a href="#" class="icon-1"></a>
                                                                                </div>
                                                ...
                                                <div class="themesflat-tabs style-1 clearfix">
                                                    <ul class="tab-title clearfix">
                                                        <li class="item-title active">
                                                            <span class="inner">Authors</span>
                                                        </li>
                                                        <li class="item-title">
                                                            <span class="inner">Corporates</span>
                                                        </li>
                                                        <li class="item-title">
                                                            <span class="inner">Publishing Houses</span>
                                                        </li>
                                                        <!-- <li class="item-title">
                                                            <span class="inner">Others</span>
                                                        </li> -->
                                                    </ul>
                                                        ...
                                                        <div class="team-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="https://www.shutterstock.com/image-photo/book-open-pages-close-up-600nw-2467818435.jpg" alt="Image">
                                                ...
                                                <div class="owl-carousel owl-theme">
                                                    <div class="themesflat-image-box style-2 clearfix">
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/imagebox/image-box-1-370x215.jpg" alt="Image">
                                                    ...
                                                    <div class="themesflat-image-box style-2 clearfix">
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/imagebox/image-box-2-370x215.jpg" alt="Image">
                                                                    <div class="overlay-effect bg-color-accent"></div>
                                                                </div>
                                                                <div class="text-wrap">
                                                    ...
                                                    <div class="themesflat-image-box style-2 clearfix">
                                                        <div class="image-box-item">
                                                            <div class="inner">
                                                                <div class="thumb data-effect-item">
                                                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/imagebox/image-box-3-370x215.jpg" alt="Image">
                                                                    <div class="overlay-effect bg-color-accent"></div>
                                                                </div>
                                                                <div class="text-wrap">
